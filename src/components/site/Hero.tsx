      ...
      <div className="hero-in">
        <div className="hero-copy">
          ...
          <p className="lede fade-up">
            From the first question you were too shy to ask, through fertility, pregnancy and postpartum — private
            consultations with Dr Hemangi, on video or in clinic. No account. No waiting room.
          </p>
