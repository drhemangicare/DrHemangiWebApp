        ...
        <div className="f-grid">
          ...
          <div>
            ...
            <div className="f-links" style={{ marginBottom: 16 }}>
              {/* Phone, address and opening hours are all promises about
                  turning up somewhere. With in-person visits switched off none
                  of them is a real route to being seen, and a phone number in
                  a footer is the first thing a patient tries — so the whole
                  group goes and the inbox is the only channel left standing.
                  Previously only the address was gated, which left a phone
                  number and clinic timings advertised by a clinic that had
                  closed its doors. */}
              {care.clinic && (
                <>
            ...
            <div className="emerg">
              ...
              {/* "for scheduled consultations only" is not true of a site that
                  schedules nothing — and this is the one paragraph a frightened
                  reader is most likely to actually read. */}
              <p>{copy.footerEmergencyLede}</p>
            </div>
          </div>
        </div>
