      ...
      {loading && !data ? (
        ...
        <>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <div className="bg-white/80 border border-black/5 rounded-2xl p-6 shadow-sm">
          ...
          <div className="bg-white/80 border border-black/5 rounded-2xl p-6 shadow-sm mt-6">
