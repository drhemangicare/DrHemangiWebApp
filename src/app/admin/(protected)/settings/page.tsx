...
async function loadSettings(): Promise<Settings> {
  ...
  return {
    ...
    doctor_registration_no: (row.doctor_registration_no as string) || "",
    doctor_qualifications: (row.doctor_qualifications as string) || "",
    online_consultation_enabled: (row.online_consultation_enabled as boolean) ?? true,
  };
}
