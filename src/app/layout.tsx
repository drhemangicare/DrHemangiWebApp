...
export const metadata: Metadata = {
  ...
  /* Neutral on purpose. This layout also wraps /admin, and the public
     description is mode-dependent — "Book a private consultation... video or
     in-clinic" was published even with both consultation switches off. The
     (site) layout overrides this with the right sentence for the current
     mode; see its generateMetadata. */
  description:
    "Dr Hemangi — MBBS, DNB, D.G.O, FMAS Laparoscopic Surgeon and Infertility Specialist (IUI & IVF). Gynaecology, fertility, pregnancy and women's wellness.",
};
